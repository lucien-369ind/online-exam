...
<body>
            ...
            <form id="quizForm">
                <?php foreach ($questions as $index => $q): ?>
                    <div class="question">
                        ...
                        <input type="hidden" name="correct<?php echo $index + 1; ?>" value="<?php echo $q['correct_option']; ?>">
                    </div>
                <?php endforeach; ?>
    ...
    <script>
        // Pass correct answers to JS for scoring
        const correctAnswers = {
            <?php foreach ($questions as $index => $q): ?>
                q<?php echo $index + 1; ?>: '<?php echo $q['correct_option']; ?>',
            <?php endforeach; ?>
        };
    </script>
</body>
